...
const RightItem = () => {
  ...
  return (
    <>
      <div className="dark:bg-dark h-full md:w-[70%] w-full p-3 flex flex-col justify-center items-center">
        <h2 className="text-3xl text-main font-medium">Create Account</h2>
        ...
        <span className="text-sm text-gray-500 dark:text-gray-400">Or register using your email address</span>
        <form
        ...
        >
          <div className="formcontrol relative">
            <input
              ...
              className="text-gray-500 text-sm pl-7 w-full placeholder:text-xs bg-[#EFF0F3]  placeholder:text-gray-400  dark:bg-secondaryDark border-0 outline-0 rounded-md p-2"
            />
          ...
          <div className="formcontrol relative">
            <input
              ...
              className="text-gray-500 text-sm pl-7 w-full placeholder:text-gray-400  dark:bg-secondaryDark placeholder:text-xs bg-[#EFF0F3] border-0 outline-0 rounded-md p-2"
            />
            <span className="absolute text-xs left-2  top-3 text-gray-400">
              <Icons.MdEmail />
            </span>
          ...
          <div className="formcontrol flex items-center gap-2">
            ...
            <label className="text-xs  text-gray-500 ml-2">
              Agree with <span className="text-main">Terms &Condition</span>
            </label>
          </div>
          ...
          <div className="m-auto mt-5">
            <Button
              disabled={isFetching}
              className="bg-main rounded-full text-xs px-13 w-fit text-white "
            >
