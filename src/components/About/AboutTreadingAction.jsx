...
const AboutTreadingAction = () => {
  return (
    <div className="dark:bg-secondaryDark min-h-screen py-8 px-2 flex flex-col items-center">
      ...
      <div className="w-full max-w-5xl flex flex-col items-start mb-8">
        ...
        <div className="w-full max-w-5xl flex flex-col items-start mb-8">
          ...
          <span className="text-gray-800 dark:text-grayDark text-lg font-bold">
            Treading <span className="text-main ">Action</span>
          </span>
        </div>
        <div className="w-full max-w-5xl flex flex-row justify-between mb-12 gap-6 flex-wrap md:flex-nowrap">
          {[1, 2, 3].map((_, i) => (
            <div
              key={i}
              className="bg-white dark:bg-dark rounded-lg shadow-md flex flex-col items-center justify-center w-60 h-24 min-w-[180px] flex-1 mx-auto mb-4 md:mb-0">
              <span className="text-gray-800 dark:text-grayDark text-2xl font-semibold">
                $45,345,654
              </span>
              <span className="text-xs font-bold text-gray-700 dark:text-grayDark mt-2 tracking-widest">
      ...
      <div className="w-full  max-w-5xl flex flex-col items-center md:items-start mb-8">
        <div className="w-full max-w-5xl flex flex-col md:flex-row items-center justify-between mt-8 bg-transparent gap-8 md:gap-0">
          ...
          <div
            className="dark:bg-gradient-to-br from-[#1b1a1a] to-[#00b7c1] about-gradient-border flex-shrink-0 flex items-center justify-center mx-auto md:mx-0"
            style={{
          ...
          <div className="flex-1 md:ml-12 flex flex-col items-center  text-center md:text-left mt-8 md:mt-0">
            <h2 className="text-2xl sm:text-3xl font-light text-gray-800 dark:text-gray-300 mb-2">
              Our <span className="text-main font-medium">mission</span>
            </h2>
            <p className="text-gray-500 text-base font-normal dark:text-grayDark mb-6 max-w-xl">
