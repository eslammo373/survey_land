...
// if (isError) return <p className="text-red-500 text-center">حدث خطأ أثناء تحميل البيانات</p>;
  ...
  return (
    <div className='space-y-6  bg-white dark:bg-dark min-h-[83vh]  rounded-2xl p-9'>
      ...
      <div className="flex flex-wrap gap-3">
        <button className="text-xs rounded-[8px] w-[150px] h-[35px] px-[20px] text-white bg-[#00B7C1] cursor-pointer hover:bg-[#b9bbc6] transition">
          Upload New Photo
            ...
            <button className="text-xs  rounded-[8px] w-[150px] h-[35px] px-[20px] text-white bg-grayLight cursor-pointer hover:bg-[#00B7C1] transition">
          Remove Photo
        </button>
      </div>
     </div>
    <div className=''>
        <form className="space-y-2 w-full grid grid-row-1 md:grid-cols-2 gap-8" >
          <div>
           <div>
            ...
            className="bg-gray-200  my-[10px] w-full indent-2 p-2 rounded-[6px] text-xs focus:outline-none dark:bg-secondaryDark"
           ...
           <div>
            ...
            className="bg-gray-200 my-[10px] dark:bg-secondaryDark w-full indent-2 p-2 rounded-[6px] text-xs focus:outline-none"
           ...
           <div>
            ...
            className="bg-[#00B7C1] px-[15px] dark:bg-secondaryDark py-[8px] rounded-[6px] text-white text-xs cursor-pointer">
              Save Changes
            </button>
          ...
          <div>
           ...
           <div>
            ...
            className="mt-2  w-full rounded-[6px] dark:bg-secondaryDark bg-gray-200 p-[7px] indent-2 text-gray-600 text-xs focus:outline-none">
           ...
           <div>
            <label className="block mt-6 font-medium text-xs  text-gray-500">Language</label>
             ...
             className='mt-2 w-full rounded-[6px] bg-gray-200 dark:bg-secondaryDark p-[7px] indent-2 text-gray-600 text-xs focus:outline-none'>
