...
const ForgetContent = () => {
  return (
    <>
      <section className="dark:bg-dark h-[100vh] flex justify-center items-center text-center ">
        <div className="">
          ...
          <form className="  md:w-[400px] flex flex-col gap-4 mt-5">
            <div className="formcontrol relative">
              <input
                ...
                className="text-gray-500 dark:bg-secondaryDark text-sm pl-8 w-full placeholder:text-gray-500  placeholder:text-xs bg-[#EFF0F3] border-0 outline-0 rounded-md p-2"
              />
