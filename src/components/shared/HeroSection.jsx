          ...
          <div className="col-span-3 text-center   md:text-start ">
            <div className="flex flex-col justify-center items-center md:items-start h-full space-y-4 text-black font-poppins ">
              ...
              <div className=" flex gap-3 ">
                ...
                <Button
                  className={`bg-white border-2 dark:bg-transparent border-main text-main dark:border-white text-xs md:text-lg w-30 lg:w-52 py-3 px-5 rounded-xl dark:text-white font-bold leading-8 capitalize transition-all  hover:bg-main hover:text-white `}
