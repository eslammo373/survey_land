...
const { currentUser } = useSelector((state) => state.user || {});
  ...
  return (
    <>
      <header
        className={`${
          theme === "dark" ? "bg-dark" : "bg-[#fafafa]"
        } sticky top-0 z-50  border-b border-gray-200  dark:border-gray-900 py-1.5 w-full`}
      >
          ...
          <div className="parnav flex justify-between items-center py-2">
            ...
            <nav className="xl:flex hidden navigation w-[65%] items-center justify-between">
              <ul className="flex items-center gap-10">
                <li>
                  <NavLink className="hover:text-main transition delay-150 ease-in-out" to="/">
                    Home
                  </NavLink>
                </li>
                <li>
                  <NavLink
                    className="hover:text-main transition delay-150 ease-in-out"
                    to="/about"
                  >
                    About Us
                  </NavLink>
            ...
            <ul className="xl:flex hidden items-center gap-4">
              <li>
                <Select>
                  <SelectTrigger className="w-[70px] text-[#FFA630] bg-white dark:bg-secondaryDark border border-[#FFA630] rounded-md">
                    <SelectValue placeholder="EN" />
                  </SelectTrigger>

                  <SelectContent className="w-[56px] border border-[#FFA630] dark:bg-secondaryDark  shadow-md bg-white">
                    <SelectGroup>
                      <SelectItem
                        value="ar"
                        className="  hover:bg-[#eeeeee] dark:bg-secondaryDark  focus:bg-[#eeeeee] text-[#FFA630] px-2 py-1"
                      >
                        AR
                      </SelectItem>
                      <SelectItem
              ...
              {currentUser?.user?.name ? (
                ...
                <>
                  <li className="bg:text-white">
                    <Link to="signin">Login</Link>
                  </li>
                  <li>
                    <Link
                      to="signup"
                      className="bg-main block w-[120px] text-center rounded-xl text-white p-2"
                    >
                      Sign Up
                    </Link>
                  </li>
            ...
            <nav
              className={`${
                ...
                theme === "dark" ? "bg-dark " : "bg-white/10"
            ...
            >
              ...
              <ul className="">
                <li className="py-4 border-y hover:text-main">
                  <Link to="/">Home</Link>
                </li>
                <li className="py-4 border-b hover:text-main">
 ...
 <li className="py-4 border-b hover:text-main">
                ...
                <ul className="flex mt-16 items-center gap-4">
                  ...
                  <li>
                    <Link to="signup" className="bg-main w-[120px] rounded-xl text-white p-2">
                      Sign Up
                    </Link>
                  </li>
                  <DarkModeToggle />
