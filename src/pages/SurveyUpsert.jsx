...
// useForm================
  ...
  return (
    <div className='min-h-screen dark:bg-secondaryDark flex flex-col mt-10'>
      <div className='flex flex-col items-center justify-center'>
        <div className="container">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className={`flex flex-col dark:bg-dark gap-6 p-7 justify-center ${theme === 'dark' ? "[box-shadow:0_4px_16px_rgba(255,255,255,0.2)] border-none" : "bg-white border-gray-200 "}  border rounded-md`}>
              <div className='flex items-center gap-2'>
                <Label htmlFor="title" className="text-sm min-w-[70px] text-[#a7a8ab] font-medium">Title:</Label>
                <Input id='title' type="text" placeholder="Enter title" className="border-1 border-gray-500 bg-gray-100 dark:bg-secondaryDark Dark:text-white" {...register('title', { required: 'Title is required' })} />
              ...
              <div className='flex items-center gap-2'>
                ...
                <Input id='description' type="text" placeholder="Enter description" className="border-1 border-gray-500 bg-gray-100 dark:bg-secondaryDark Dark:text-white"  {...register('description', { required: 'Title is required' })} />
              ...
              <div className='flex gap-2 justify-end'>
                ...
                <Button
                  ...
                  className={`w-32 font-medium ${isload === 'true'
                      ...
                      : 'bg-main text-white hover:bg-[#b9feffe8] hover:text-main hover:font-bold'
                    }`}
                >
